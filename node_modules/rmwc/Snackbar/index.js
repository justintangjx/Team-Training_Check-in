...
var Snackbar = (0, _Base.withMDC)({
  ...
  mdcElementRef: true,
  mdcEvents: {
    'MDCSnackbar:show': function MDCSnackbarShow(evt, props, api) {
      return props.onShow(evt);
    },
    'MDCSnackbar:hide': function MDCSnackbarHide(evt, props, api) {
      return props.onHide(evt);
    }
  },
  defaultProps: {
    show: false,
  ...
  _createClass(_class, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['show', 'message', 'timeout', 'actionHandler', 'actionText', 'multiline', 'actionOnBottom', 'mdcElementRef', 'dismissesOnAction', 'onHide', 'onShow', 'children']);
